...
void bienvenida() {
    ...
    printf("%i producto(s) agregado(s)\n\n", dulces + salados);
}
...
void mostrarReporte() {
	...
	printf("\nB7 - Codigo: (%i) - ", gananciaMayor.rango);
	printf(gananciaMayor.rango <= 10 ? "Salado" : "Dulce");
